export class Board {
    ...
    public static moveToPoint(scene: BABYLON.Scene, token: BABYLON.AbstractMesh, pointKey: string) {
        const jumpHeight = 8;
        ...
        scene.beginAnimation(token, 0, 60, false);
    }

    public static diceRoll(scene: BABYLON.Scene, dice: BABYLON.AbstractMesh, number: number) {
        if (
            dice.metadata &&
        ...
        scene.beginAnimation(dice, 0, 120, false, 1, () => {
